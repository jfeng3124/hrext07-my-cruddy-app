...
<Link to={{pathname: '/', search: '' }} style={{ textDecoration: 'none' }}>
            <Button variant="danger" size="xs" onClick={this.closeModal}><span className="closebtn glyphicon glyphicon-remove"></span></Button>
          </Link><br/>
<fieldset>
...
<div className='button-center'>
              <br/>
              <Button variant="warning" size="small" onClick={this.onClick}>Update</Button>
            </div>
          </Modal>
        </div>
      )
...
<div className='button-center'>
              ...
              <Link to={{pathname: '/', search: '' }} style={{ textDecoration: 'none' }}>
                <Button variant="success" size="xs" onClick={this.closeModal}>Close the Dialog</Button>
              </Link>
            </div>
          </Modal>
        </div>
